...
Original file is located at
    https://colab.research.google.com/drive/1MH7JXDbgdY-xf3vyeZUegLHzGLxnDPAE
"""
...
features = ['keywords','cast','genres','director','title','vote_count']
df[features].head(3)
...
def combine_features(row):
    return row['keywords'] +" "+row['cast']+" "+row["genres"]+" "+row["director"]+" "+row["title"]
